...
#define CONFIG_INTEL_DMIC_FIR_DECIMATE_BY_2 1
#define CONFIG_INTEL_DMIC_FIR_DECIMATE_BY_3 1
#define CONFIG_INTEL_DMIC_FIR_DECIMATE_BY_4 1
#define CONFIG_INTEL_DMIC_FIR_DECIMATE_BY_5 1
#define CONFIG_INTEL_DMIC_FIR_DECIMATE_BY_6 1
#define CONFIG_INTEL_DMIC_FIR_DECIMATE_BY_8 1
#define CONFIG_INTEL_DMIC_FIR_DECIMATE_BY_12 1
